...
public class ContractGenerator {
    ...
    public ContractGenerator(final TableDefinition tableDefinition, final Set<ColumnDefinition> fields) {
        ...
        extend(classBuilder, contractFields);
    ...
    private void extend( final TypeSpec.Builder classBuilder, final Set<ColumnDefinition> fields) {
        ...
        classBuilder.addMethod(
                MethodSpec.methodBuilder("onCreate")
                        ...
                        .addCode(createTableStatement(fields))
    ...
    private CodeBlock createTableStatement( final Set<ColumnDefinition> fields) {
