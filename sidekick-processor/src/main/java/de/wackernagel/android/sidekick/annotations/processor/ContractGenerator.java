...
public class ContractGenerator {
    ...
    public ContractGenerator(final TableDefinition tableDefinition, final Set<ColumnDefinition> fields) {
        ...
        extend(classBuilder, tableDefinition.getTableName(), contractFields);
    ...
    private void extend( final TypeSpec.Builder classBuilder, final String table, final Set<ColumnDefinition> fields) {
    ...
    private String createTableStatement( final String table, final Set<ColumnDefinition> fields) {
